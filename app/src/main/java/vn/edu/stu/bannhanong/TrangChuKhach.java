...
public class TrangChuKhach extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trang_chu_khach);
    ...
    private void addEvents() {
        btnChonongsan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(TrangChuKhach.this, ChoNongSan.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_tuongtoi) {
            ...
            Intent intent=new Intent(TrangChuKhach.this,Login.class);
            startActivity(intent);
            finish();
        }
        return true;
